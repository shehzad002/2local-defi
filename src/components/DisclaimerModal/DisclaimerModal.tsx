...
const DisclaimerModal: React.FC<DisclaimerModal> = ({
  ...
  const modalContent = useMemo(() => {
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p> Omakase Bar will be the home of our new frontend, and provides
              an interface for all interactions with the 2local protocol.
          </p>
          <p> Development will be on going, and l2lswapclassic will still
      ...
      return (
        <div>
          <StyledLink target="_blank" href="https://l2lswap.fi">
